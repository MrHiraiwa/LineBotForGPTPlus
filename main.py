...
DEFAULT_ENV_VARS = {
    ...
    'OCR_MESSAGE': ' 動画を解析し文字に変換しました。以下の解析結果を{display_name}に報告してください 。',
    'OCR_BOTGUIDE_MESSAGE': '以下のテキストは動画を解析し文字列に変換したものです。動画に何が写っているかを文章で説明してください。',
    'OCR_USER_MESSAGE': '動画を送信しました。',
    'VIDEO_MESSAGE': ' 画像を解析し文字に変換しました。以下の解析結果を{display_name}に報告してください 。',
    'VIDEO_BOTGUIDE_MESSAGE': '以下のテキストは画像を解析し文字列に変換したものです。画像に何が写っているかを文章で説明してください。',
    'VIDEO_USER_MESSAGE': '画像を送信しました。',
