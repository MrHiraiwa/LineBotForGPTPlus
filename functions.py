...
def chatgpt_functions(GPT_MODEL, messages_for_api, USER_ID, message_id, ERROR_MESSAGE, PAINT_PROMPT, BUCKET_NAME, FILE_AGE, GOOGLE_DESCRIPTION, EXTEA_DESCRIPTION, max_attempts=5):
    public_img_url = None
    ...
    while attempt < max_attempts:
        response = run_conversation_f(GPT_MODEL, i_messages_for_api, google_description, extra_description, attempt)
        if response:
