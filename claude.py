...
def claude_functions(CLAUDE_MODEL, SYSTEM_PROMPT ,messages_for_api, USER_ID, MESSAGE_ID, ERROR_MESSAGE, PAINT_PROMPT, BUCKET_NAME, FILE_AGE, GOOGLE_DESCRIPTION, CUSTOM_DESCRIPTION, max_attempts=5):
    ...
    head_message = {'role': 'assistant', 'content': SYSTEM_PROMPT}
    head_message.append(i_messages_for_api)
    response = run_conversation_f(CLAUDE_MODEL, head_message, GOOGLE_DESCRIPTION, CUSTOM_DESCRIPTION)
    bot_reply = response
